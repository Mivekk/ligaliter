...
const fetchGameData_1 = require("./fetchGameData");
...
const game_input_1 = require("./game-input");
...
__decorate([
    (0, type_graphql_1.Mutation)(() => game_types_1.GameResponseObject, { nullable: true }),
...
__decorate([
    ...
    (0, type_graphql_1.Query)(() => [game_types_1.Tile], { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)("uuid")),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, type_graphql_1.UseMiddleware)(isAuth_1.isAuth),
    (0, type_graphql_1.Subscription)(() => [game_types_1.Tile], {
        nullable: true,
...
__decorate([
    ...
    __param(0, (0, type_graphql_1.Arg)("input", () => game_input_1.MoveTileInput)),
    __param(1, (0, type_graphql_1.Ctx)()),
    __param(2, (0, type_graphql_1.PubSub)(types_1.TOPICS.TILE_UPDATED)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [game_input_1.MoveTileInput, Object, Function]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(2, (0, type_graphql_1.PubSub)(types_1.TOPICS.TILE_UPDATED)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [game_input_1.PlayTurnInput, Object, Function]),
    __metadata("design:returntype", Promise)
], GameResolver.prototype, "playTurn", null);
__decorate([
    (0, type_graphql_1.UseMiddleware)(isAuth_1.isAuth),
    (0, type_graphql_1.Query)(() => game_types_1.GameInfoResponseObject, { nullable: true }),
    __param(0, (0, type_graphql_1.Arg)("uuid")),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], GameResolver.prototype, "playerInfo", null);
