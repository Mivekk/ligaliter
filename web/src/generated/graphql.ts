...
export type NewGameMutation = {
  ...
  newGame?: {
    __typename?: "GameResponseObject";
    players: Array<{ __typename?: "IdsFormat"; id: number }>;
  } | null;
};
...
export type GetBoardTilesQuery = {
  __typename?: "Query";
  getBoardTiles?: Array<{
    __typename?: "Tile";
    id: number;
...
export type GetLobbyPlayersQuery = {
  __typename?: "Query";
  getLobbyPlayers: {
    __typename?: "LobbyQueryResponseObject";
    owner?: {
...
export type GetPlayerStatsQuery = {
  ...
  getPlayerStats?: {
    __typename?: "GameInfoResponseObject";
    id: number;
    activePlayer: { __typename?: "User"; id: number; username: string };
    players: Array<{
      __typename?: "PlayerStats";
      id: number;
      username: string;
...
export type GetPlayerTilesQuery = {
  __typename?: "Query";
  getPlayerTiles?: Array<{
    __typename?: "Tile";
    id: number;
    letter: string;
    draggable: boolean;
...
export type UpdateBoardTilesSubscription = {
  __typename?: "Subscription";
  updateBoardTiles?: Array<{
    __typename?: "Tile";
    id: number;
    letter: string;
    draggable: boolean;
...
export type UpdateLobbyPlayersSubscription = {
  __typename?: "Subscription";
  updateLobbyPlayers: {
    __typename?: "LobbyReponseObject";
    started: boolean;
...
export type UpdatePlayerStatsSubscription = {
  __typename?: "Subscription";
  updatePlayerStats?: {
    __typename?: "GameInfoResponseObject";
    id: number;
...
export const EndTurnDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "EndTurn" },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "PlayTurnInput" },
            },
          },
        },
      ],
...
} as unknown as DocumentNode<EndTurnMutation, EndTurnMutationVariables>;
export const JoinLobbyDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "JoinLobby" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<JoinLobbyMutation, JoinLobbyMutationVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "MoveTileInput" },
            },
          },
        },
      ],
...
} as unknown as DocumentNode<MoveTileMutation, MoveTileMutationVariables>;
...
} as unknown as DocumentNode<NewGameMutation, NewGameMutationVariables>;
export const NewLobbyDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "NewLobby" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "uuid" } },
...
} as unknown as DocumentNode<NewLobbyMutation, NewLobbyMutationVariables>;
export const QuitLobbyDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "QuitLobby" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "uuid" } },
...
} as unknown as DocumentNode<QuitLobbyMutation, QuitLobbyMutationVariables>;
...
export const GetBoardTilesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetBoardTiles" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "uuid" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "placed" } },
...
} as unknown as DocumentNode<GetBoardTilesQuery, GetBoardTilesQueryVariables>;
export const GetLobbyPlayersDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetPlayerTiles" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "uuid" } },
...
} as unknown as DocumentNode<GetPlayerTilesQuery, GetPlayerTilesQueryVariables>;
...
export const UpdateBoardTilesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "UpdateBoardTiles" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "uuid" } },
  ...
  UpdateBoardTilesSubscription,
  UpdateBoardTilesSubscriptionVariables
>;
export const UpdateLobbyPlayersDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "UpdateLobbyPlayers" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "uuid" } },
  ...
  UpdateLobbyPlayersSubscription,
  UpdateLobbyPlayersSubscriptionVariables
>;
export const UpdatePlayerStatsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "UpdatePlayerStats" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "uuid" } },
  ...
  UpdatePlayerStatsSubscription,
  UpdatePlayerStatsSubscriptionVariables
>;
